"""Launcher for Fig2d render export.
...
SRC_PNG = ROOT / "analysis_viz/figures/v2_subplots/G1_dataset/G1d_icd_chapter_v2.png"
...
def copy_required_sidecar(suffix: str, render_dir: Path) -> Path:
    ...
    out_path = render_dir / f"Fig2d{suffix}"
