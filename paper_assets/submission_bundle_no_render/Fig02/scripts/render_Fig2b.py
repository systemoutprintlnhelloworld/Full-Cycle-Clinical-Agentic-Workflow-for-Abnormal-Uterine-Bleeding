"""Launcher for Fig2b render export.
...
SRC_PNG = ROOT / "analysis_viz/figures/v2_subplots/G1_dataset/G1b_palm_coein_stage_bar_v1.png"
...
def copy_required_sidecar(suffix: str, render_dir: Path) -> Path:
    ...
    out_path = render_dir / f"Fig2b{suffix}"
