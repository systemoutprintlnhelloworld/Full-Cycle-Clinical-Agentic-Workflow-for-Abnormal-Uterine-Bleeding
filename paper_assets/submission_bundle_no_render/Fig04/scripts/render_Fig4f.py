"""Launcher for Fig4f render export.
...
SRC_PNG = ROOT / "analysis_viz/figures/v2_subplots/G3_continuity/G3F_reasoning_event_count_v2.png"
...
def copy_required_sidecar(suffix: str, render_dir: Path) -> Path:
    ...
    out_path = render_dir / f"Fig4f{suffix}"
