"""Launcher for Fig4d render export.
...
SRC_PNG = ROOT / "analysis_viz/figures/v2_subplots/G3_continuity/G3D_memory_event_count_v2.png"
...
def copy_required_sidecar(suffix: str, render_dir: Path) -> Path:
    ...
    out_path = render_dir / f"Fig4d{suffix}"
