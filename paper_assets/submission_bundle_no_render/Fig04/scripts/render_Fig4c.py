"""Launcher for Fig4c render export.
...
SRC_PNG = ROOT / "analysis_viz/figures/v2_subplots/G3_continuity/G3C_reasoning_trend_v2.png"
...
def copy_required_sidecar(suffix: str, render_dir: Path) -> Path:
    ...
    out_path = render_dir / f"Fig4c{suffix}"
