"""Launcher for Fig1c render export.
...
SRC_PNG = ROOT / "analysis_viz/figures/v2_subplots/S1_manual_vs_llm/S1_manual_vs_llm_side_by_side_bar_v1.png"
...
def copy_required_sidecar(suffix: str, render_dir: Path) -> Path:
    ...
    out_path = render_dir / f"Fig1c{suffix}"
