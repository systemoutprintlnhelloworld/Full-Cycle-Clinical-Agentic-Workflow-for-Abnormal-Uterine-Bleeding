"""Launcher for Fig3c render export.
...
SRC_PNG = ROOT / "analysis_viz/figures/v2_subplots/G2_outcome/G2C_check_efficiency_merged_v3.png"
...
def copy_required_sidecar(suffix: str, render_dir: Path) -> Path:
    ...
    out_path = render_dir / f"Fig3c{suffix}"
