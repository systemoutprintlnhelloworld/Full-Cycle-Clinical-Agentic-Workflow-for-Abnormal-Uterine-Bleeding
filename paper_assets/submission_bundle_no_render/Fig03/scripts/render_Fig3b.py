"""Launcher for Fig3b render export.
...
SRC_PNG = ROOT / "analysis_viz/figures/v2_subplots/G2_outcome/G2B_diag_robustness_final_palm_v2.png"
...
def copy_required_sidecar(suffix: str, render_dir: Path) -> Path:
    ...
    out_path = render_dir / f"Fig3b{suffix}"
