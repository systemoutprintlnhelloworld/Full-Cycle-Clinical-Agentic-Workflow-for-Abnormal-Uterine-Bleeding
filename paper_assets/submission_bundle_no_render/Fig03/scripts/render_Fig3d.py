"""Launcher for Fig3d render export.
...
SRC_PNG = ROOT / "analysis_viz/figures/v2_subplots/G2_outcome/G2D_plan_alignment_semantic_v1.png"
...
def copy_required_sidecar(suffix: str, render_dir: Path) -> Path:
    ...
    out_path = render_dir / f"Fig3d{suffix}"
