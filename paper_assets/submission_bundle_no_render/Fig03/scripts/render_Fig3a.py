"""Launcher for Fig3a render export.
...
SRC_PNG = ROOT / "analysis_viz/figures/v2_subplots/G2_outcome/G2A_diagnostic_quality_v2.png"
...
def copy_required_sidecar(suffix: str, render_dir: Path) -> Path:
    ...
    out_path = render_dir / f"Fig3a{suffix}"
