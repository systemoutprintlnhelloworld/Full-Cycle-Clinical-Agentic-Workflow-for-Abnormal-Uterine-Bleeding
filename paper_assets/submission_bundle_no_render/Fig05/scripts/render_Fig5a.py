"""Launcher for Fig5a render export.
...
SRC_PNG = ROOT / "analysis_viz/figures/v2_subplots/G4_system/G4A_sankey_arrow_rect_v1.png"
...
def copy_required_sidecar(suffix: str, render_dir: Path) -> Path:
    ...
    out_path = render_dir / f"Fig5a{suffix}"
