"""Launcher for Fig5b render export.
...
SRC_PNG = ROOT / "analysis_viz/figures/v2_subplots/G4_system/G4B_calibration_overall_weighted_v6.png"
...
def copy_required_sidecar(suffix: str, render_dir: Path) -> Path:
    ...
    out_path = render_dir / f"Fig5b{suffix}"
