"""Launcher for Fig5c render export.
...
SRC_PNG = ROOT / "analysis_viz/figures/v2_subplots/G4_system/G4C_ablation_diag_dumbbell_v1.png"
...
def copy_required_sidecar(suffix: str, render_dir: Path) -> Path:
    ...
    out_path = render_dir / f"Fig5c{suffix}"
